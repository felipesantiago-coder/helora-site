...
export const ALL_CONVENIOS: Convenio[] = [
  ...
  { name: 'ALLIANZ', src: '/convenios/allianz.webp' },
  ...
  { name: 'CAPESESP', src: '/convenios/capsesp.webp' },
  ...
  { name: 'SAMP AGMP', src: '/convenios/samp-agmp.webp' },
  ...
  { name: 'TST', src: '/convenios/tst.webp' },
  { name: 'UNAFISCO SAÚDE', src: '/convenios/unafisco-saude.webp' },
  { name: 'UNIMED VTRP', src: '/convenios/unimed-vtrp.webp' },
];
