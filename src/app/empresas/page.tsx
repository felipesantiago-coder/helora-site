        ...
        <section className="bg-[#9C6146] py-20 sm:py-24 md:py-32">
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="max-w-[700px]">
              ...
              <p className="font-sans text-white/85 text-[0.95rem] sm:text-base md:text-[1.063rem] leading-[1.8] max-w-[560px] mb-10">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 font-sans text-[13px] tracking-[0.1em] uppercase font-medium px-8 py-3.5 rounded-full bg-white text-[#2C241C] hover:bg-white/90 transition-all duration-300"
              >
          ...
          <div className="max-w-[1200px] mx-auto px-6">
            <div className="max-w-[700px] mb-14">
              ...
              <h2 className="font-serif text-[1.75rem] sm:text-[2.25rem] md:text-[2.75rem] text-[#2C2C2C] leading-[1.2] mb-4 text-balance">
                Soluções em saúde mental para a sua organização.
              </h2>
            </div>
